...
namespace gl
{
    ...
    template<>
    class uniform_resolver<glm::mat4>
    {
    public:
    ...
    template<>
    class uniform_resolver<glm::vec3>
    {
    public:
    ...
    template<>
    class uniform_resolver<glm::vec2>
    {
    public:
    ...
    template<>
    class uniform_resolver<int32_t>
    {
    public:
